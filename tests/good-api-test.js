...
transifex = new _transifex.Transifex({
...
describe("Resource API", function () {
  ...
  it("The resourceCreateMethod function posts and returns JSON", function (done) {
    (0, _should2.default)(function () {
      (0, _nock2.default)("https://www.transifex.com").post("/api/2/project/transifex/resources/").reply(201, '[0, 1, 0]');
  ...
  it("The resourceDeleteMethod function returns no content", function (done) {
    (0, _should2.default)(function () {
      ...
      (0, _nock2.default)("https://www.transifex.com").delete("/api/2/project/transifex/resource/test/?details").reply(204);
  ...
  it("The resourcesSetMethod function returns JSON-encoded list with details", function (done) {
    (0, _should2.default)(function () {
      transifex.resourcesSetMethod("transifex", function (err, data) {
        data.should.match(function (it) {
          return it[0].should.have.properties('name');
        });
        done();
      });
    }).not.throw();
  ...
  it("The uploadSourceLanguageMethod function puts source message", function (done) {
    (0, _should2.default)(function () {
      (0, _nock2.default)("https://www.transifex.com").put("/api/2/project/transifex/resource/sample/content/").reply(201, {
        "strings_added": 0,
        "strings_updated": 0,
        "strings_delete": 0,
  ...
  it("The languageSetMethod function returns a JSON encoded list with the fields language_code, coordinators, translators and reviewers.", function (done) {
    (0, _should2.default)(function () {
      transifex.languageSetMethod("node-transifex-sample", function (err, data) {
        data.should.match(function (it) {
          return it[0].should.have.properties('language_code', 'translators', 'reviewers');
        });
        done();
      });
    }).not.throw();
...
describe("Translations API", function () {
  ...
  it("translationStringsPutMethod specific string", function (done) {
    (0, _should2.default)(function () {
      var content = [{ key: "This is cool. Super Cool!", translation: "Das ist cool. Super cool!" }];
      (0, _nock2.default)("https://www.transifex.com").put("/api/2/project/node-transifex-sample/resource/source-file/translation/de/strings/").reply(201, content);
  ...
  it("The uploadTranslationInstanceMethod function puts translation content", function (done) {
    (0, _should2.default)(function () {
      (0, _nock2.default)("https://www.transifex.com").put("/api/2/project/transifex/resource/sample/translation/es/?file").reply(201, {
        "strings_added": 1,
        "strings_updated": 0,
        "strings_delete": 0,
        "redirect": "/transifex/transifex/sample/"
