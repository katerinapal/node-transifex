...
function main() {
  ...
  program.option('-u, --credential <user:pass>', 'specify a Transifex username and password in the form username:password').option('-p, --project <slug>', 'specify project slug').option('-c, --category <name>', 'specify project category name').option('-d, --dir <path>', 'locale dir for the downloaded files').option('-s, --source_language', 'override source_language (false by default)').option('-m, --meta', 'download meta info files (false by default)').parse(process.argv);
